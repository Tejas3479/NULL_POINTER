...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-[#00FF41] font-mono flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none bg-[linear-gradient(to_right,#00FF41_1px,transparent_1px),linear-gradient(to_bottom,#00FF41_1px,transparent_1px)] bg-[size:30px_30px]" />

      <motion.div 
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-[480px] bg-black border border-[#00FF41]/40 rounded p-8 relative z-10 shadow-[0_0_50px_rgba(0,255,65,0.1)]"
      >
        {/* Terminal Header Bar */}
        <div className="absolute top-0 inset-x-0 h-6 bg-[#00FF41]/10 border-b border-[#00FF41]/30 flex items-center px-4 justify-between">
          <span className="text-[9px] uppercase tracking-widest font-black">SSO_LOGIN_GATEWAY_V.1.0</span>
        ...
        <div className="flex flex-col items-center gap-4 mt-4 mb-8">
          <div className="bg-[#00FF41]/10 p-4 border border-[#00FF41]/30 rounded-full shadow-[0_0_20px_rgba(0,255,65,0.15)]">
            <Cpu className="text-[#00FF41] animate-pulse" size={36} />
          </div>
          <div className="text-center">
            <h1 className="font-orbitron text-2xl font-black tracking-[0.15em] text-white">NULL_POINTER</h1>
            <p className="text-[10px] uppercase tracking-widest text-[#00FF41]/50 font-bold mt-1">SENTIENT_SIMULATION_AUTH</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="text-[9px] uppercase tracking-widest text-[#00FF41]/60 font-bold mb-1">SSO Providers</div>
            <button
              onClick={() => handleOAuthLogin('github')}
              disabled={loading}
              className="w-full py-3 px-4 rounded border border-[#00FF41]/30 bg-[#00FF41]/5 hover:bg-[#00FF41]/15 text-white font-orbitron text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
              <Code size={14} />
              Sign In With GitHub
            </button>
          ...
          <div className="border-t border-[#00FF41]/20 pt-6 space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-[9px] uppercase tracking-widest text-[#00FF41]/60 font-bold flex items-center gap-1">
                <Terminal size={10} />
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 bg-[#00FF41] hover:bg-[#00FF41]/80 text-black font-orbitron text-xs font-black uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_15px_rgba(0,255,65,0.2)] disabled:opacity-50"
            >
              <Lock size={12} />
        ...
        <div className="text-[8px] text-[#00FF41]/30 uppercase text-center mt-8 tracking-wider">
