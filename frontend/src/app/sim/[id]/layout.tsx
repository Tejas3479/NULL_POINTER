...
export default function SimulationLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loadingAuth) {
    return (
      <main className="min-h-screen bg-black text-cyan-400 font-mono flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-4 relative z-10">
          <div className="w-8 h-8 border-2 border-t-transparent border-cyan-400 rounded-full animate-spin mx-auto" />
          <p className="text-xs uppercase tracking-widest text-cyan-400/60 font-bold">Verifying quantum defense authorization keys...</p>
        </div>
      </main>
    );
  }
