...
export default function AgentsPage() {
  ...
  return (
    <div className="flex-grow p-6 h-full min-h-0 overflow-hidden select-none font-mono">
      <ResizableLayout
        left={
          <section className="flex flex-col gap-4 h-full overflow-hidden pr-2">
        ...
        right={
          <section className="flex flex-col gap-4 h-full overflow-y-auto select-none pl-2 pr-1">
            {selectedAgent ? (
        ...
        defaultLeftPercentage={40}
        minLeftPercentage={25}
        maxLeftPercentage={60}
